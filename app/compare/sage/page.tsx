...
export const metadata: Metadata = {
  ...
  description: ensureMinDescription(
    "PayrollJamaica vs Sage Payroll: which is better for Jamaican businesses? Compare PAYE, NIS, NHT compliance, local bank formats, SO1/P24 reports, Jamaica pricing, and local support.",
    baseDescription
  ),
