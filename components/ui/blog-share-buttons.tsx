    ...
    <div className="flex items-center gap-2 mt-6 mb-8">
      ...
      {shareLinks.map((link) => (
        <a
          ...
          className="inline-flex items-center justify-center size-8 rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors"
        >
          {link.icon}
        </a>
      ))}
