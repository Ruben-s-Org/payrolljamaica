---
title: "March 31 Jamaica Payroll Deadline 2026: Last-Minute Employer Guide"
description: "Jamaica's 2025/26 tax year ends March 31. Here's exactly what every employer must file before the deadline — SO1, NHT, NIS — plus penalties for missing it."
date: "2026-03-11"
tags: ["March 31 Jamaica", "Jamaica tax year end", "SO1 return Jamaica", "NHT annual return", "NIS reconciliation", "PAYE filing deadline", "Jamaica payroll deadline 2026", "TAJ filing"]
author: "Payroll Jamaica Team"
canonical: "https://payrolljamaica.com/blog/march-31-jamaica-payroll-deadline-last-minute-guide-2026"
---

# March 31 Jamaica Payroll Deadline 2026: Your Last-Minute Employer Guide
...
| Return | Where to File | Deadline |
|---|---|---|
| **SO1 Annual Return** (PAYE + all statutory deductions) | TAJ — in person or eTAJ portal | March 31, 2026 |
| **NHT Annual Return** | nht.gov.jm or NHT office | March 31, 2026 |
| **NIS Annual Reconciliation** | NIS branch | March 31, 2026 |
| **P6 Earnings Certificates** | Issue to employees on request | On demand (employees need for April 14 personal tax) |
...
- **Online:** Log in at [etaj.gov.jm](https://etaj.gov.jm) → Returns → SO1 Annual Return
...
- Log in at [nht.gov.jm](https://nht.gov.jm) → Employer Services → Annual Return
...
- Any employee who earned above the income tax threshold ($1,500,096 for 2025/26) may need a P6
...
| Deduction | Employee Rate | Employer Rate | Annual Ceiling |
|---|---|---|---|
| **PAYE Income Tax** | 25% on income above $1,500,096/year | — | None |
| **NIS** | 3% | 3% | $5,000,000/year gross |
| **NHT** | 2% | 3% | None |
| **Education Tax** | 2.25% | 3.5% | None |
| **HEART** | — | 3% | Employers above $173k/month payroll |

**Income Tax Threshold 2025/26:** JMD $1,500,096/year = $125,008/month = $28,848/week
...
1. **Monthly S02 totals don't match the SO1** — TAJ compares these automatically
2. **PAYE applied below the threshold** — tax-free income incorrectly taxed (TAJ sometimes flags over-deductions too, as employees complain)
3. **NIS deducted beyond the ceiling** — continuing to deduct NIS after an employee's gross pay exceeds $5M
4. **Education Tax rate error** — common mix-up: employee rate is 2.25%, employer rate is 3.5%
5. **Missing employees on the SO1** — especially part-time or temporary staff who were paid at some point during the year
