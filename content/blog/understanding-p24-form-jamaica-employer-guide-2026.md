---
title: "Understanding Your P24 Form: Jamaica Employer Guide 2026"
description: "Everything Jamaican employers need to know about the P24 form — what it is, when to use it, how to fill it out correctly, and how it connects to your SO1 and S02 filings with TAJ."
date: "2026-03-19"
tags: ["P24 form Jamaica", "Jamaica employer tax form", "TAJ forms Jamaica", "P24 guide 2026", "Jamaica payroll forms", "PAYE reporting Jamaica", "SO1 filing Jamaica", "Jamaica tax compliance"]
author: "Payroll Jamaica Team"
canonical: "https://payrolljamaica.com/blog/understanding-p24-form-jamaica-employer-guide-2026"
---

# Understanding Your P24 Form: Jamaica Employer Guide 2026
...
| Deduction | What to Report |
|---|---|
| **PAYE** | Total income tax deducted from all employees |
| **NIS (employee share)** | Total NIS at 3% (subject to J$5,000,000 ceiling per employee) |
| **NHT (employee share)** | Total NHT at 2% (no ceiling) |
| **Education Tax (employee share)** | Total Education Tax at 2.25% (no ceiling) |
...
| Contribution | Rate |
|---|---|
| **NIS (employer share)** | 3% (subject to J$5,000,000 ceiling per employee) |
| **NHT (employer share)** | 3% (no ceiling) |
| **Education Tax (employer share)** | 3.5% (no ceiling) |
| **HEART/NSTA** | 3% (employer only, no ceiling) |
...
| Category | P24 Amount (Should Have Paid) | S02 Total (Actually Paid) | Difference |
|---|---|---|---|
| PAYE | | | |
| NIS | | | |
| NHT | | | |
...
If you made NIS ceiling errors at the employee level (see our [guide to common NIS mistakes](/blog/common-nis-calculation-mistakes-jamaican-employers)), those errors will carry through to the P24.
...
If you have not registered for TAJ's online services, do so now at [www.jamaicatax.gov.jm](https://www.jamaicatax.gov.jm).
...
[PayrollJamaica](/) calculates every statutory deduction — PAYE (with the correct J$1,500,096 threshold), NIS (with the J$5,000,000 ceiling), NHT (2% + 3%), Education Tax (2.25% + 3.5%), and HEART/NSTA (3%) — automatically for every pay period.
...
Use our [payroll calculator](/calculator) to verify any individual employee's deductions, or [explore our plans](/pricing) to see how the full platform handles year-end reporting.
