---
title: "6 Days to March 31: The 6 Filing Mistakes That Trigger TAJ Penalties in Jamaica"
description: "The six most common SO1 Annual Return mistakes Jamaican employers make — and how to fix them before the March 31 deadline triggers automatic TAJ penalties."
date: "2026-03-25"
tags: ["Jamaica payroll deadline 2026", "SO1 annual return Jamaica", "TAJ penalties Jamaica", "PAYE filing mistakes Jamaica", "employer compliance 2026", "SO1 errors Jamaica", "Jamaica payroll 2026"]
author: "Payroll Jamaica Team"
canonical: "https://payrolljamaica.com/blog/6-days-to-march-31-jamaica-payroll-filing-mistakes-2026"
---

# 6 Days to March 31: The 6 Filing Mistakes That Trigger TAJ Penalties in Jamaica

Six days. You might be ready to file. You might have your payroll register sitting in a spreadsheet, your eTAJ login ready, and a quiet hour this afternoon to submit. That is good. But before you click submit, read this post.
...
Jamaica's income tax threshold — the annual income below which PAYE is not charged — has changed multiple times over the past five years. In 2020, it was J$1,272,000. It moved to J$1,500,096 in later years. Many employers, particularly those running payroll in Excel or using older software, are still applying the 2020 or 2022 threshold to their 2025 payroll.
...
**How to fix it before you file:** For tax year 2025, verify you are using the current income tax threshold. Cross-check each employee's annual gross pay against the threshold calculation. The [PayrollJamaica calculator](https://payrolljamaica.com/calculator) applies the current statutory threshold automatically — run your employees through it and compare the result to what your records show was actually deducted. If there is a discrepancy, you need to address it on the SO1.
...
- Education Tax employer contribution: **3.5%** of gross wages
...
2. Verify your PAYE calculations against the current threshold using the [PayrollJamaica calculator](https://payrolljamaica.com/calculator)
