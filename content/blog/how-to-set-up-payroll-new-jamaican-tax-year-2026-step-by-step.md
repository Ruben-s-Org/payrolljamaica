# How to Set Up Payroll Correctly for the New Jamaican Tax Year (Step-by-Step)
...
The income tax threshold for 2026 is **J$1,500,096 per year**, which works out to **J$125,008 per month**. This is the income level below which no PAYE is deducted.
...
Enter the threshold as a monthly figure (J$125,008) if your system calculates monthly, or divide appropriately for weekly (J$28,848) or fortnightly (J$57,696) pay runs.
...
Before processing your first real April payroll, run a test calculation for two or three employees — ideally one below the PAYE threshold, one above it, and one close to the NIS ceiling. Cross-check the results against the **PayrollJamaica calculator** at [payrolljamaica.com/calculator](https://payrolljamaica.com/calculator).
