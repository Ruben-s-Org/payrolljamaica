---
title: "How to Prepare Your SO1 Annual Return in Jamaica: 2026 Step-by-Step Guide"
description: "Complete step-by-step guide to preparing and filing your SO1 annual return in Jamaica before the March 31, 2026 deadline. Covers what information you need, the TAJ portal filing process, common errors to avoid, and how to generate SO1-compliant data automatically."
date: "2026-03-11"
tags: ["SO1 annual return Jamaica 2026", "how to file SO1 Jamaica", "SO1 form Jamaica employer", "Jamaica annual return payroll", "TAJ annual return Jamaica 2026", "PAYE annual return Jamaica", "SO1 filing guide Jamaica"]
author: "Payroll Jamaica Team"
canonical: "https://payrolljamaica.com/blog/how-to-prepare-so1-annual-return-jamaica-2026"
seo:
  title: "How to Prepare Your SO1 Annual Return in Jamaica — 2026 Step-by-Step Guide"
  description: "Step-by-step guide to preparing and filing the SO1 annual return in Jamaica by March 31, 2026. What information you need, how to file via the TAJ portal, common errors to avoid, and how PayrollJamaica generates SO1-compliant data automatically."
---

# How to Prepare Your SO1 Annual Return in Jamaica: 2026 Step-by-Step Guide
...
| Field | Details |
|---|---|
| **Full legal name** | As it appears on their TRN registration |
| **TRN (Tax Registration Number)** | Critical — TAJ uses this to match contributions to the individual's record |
| **Period of employment** | Start and end dates if they joined or left during the year |
| **Total gross wages paid** | All remuneration: salary, overtime, bonuses, commission, allowances, service charge |
| **Total PAYE deducted** | Income tax withheld across all pay periods |
| **Total NIS deducted** | Employee NIS contributions (3% of gross wages up to the contribution ceiling) |
| **Total Education Tax deducted** | 2.25% of gross wages |
| **Total NHT deducted** | Employee NHT (2% of gross wages) — reported on the P24 |
...
**Time estimate (manual):** 4–12 hours depending on headcount and how well-organised your monthly records are.
**Time estimate (PayrollJamaica):** 2–5 minutes.
...
**Action items:**
1. Run a report listing all employees and their TRNs
2. Identify any employees with blank or clearly incorrect TRN fields (TRNs are 9-digit numbers)
3. Contact those employees to obtain their TRN before you submit
4. For employees who have already left the company, check personnel files for their TRN
...
- **Annual income tax threshold**: J$1,500,096 (J$125,008 per month)
...
Use the **[PayrollJamaica free calculator](https://payrolljamaica.com/calculator)** to verify what any employee's deductions should be based on their gross pay.
...
TAJ's e-Services portal at [etax.taj.gov.jm](https://etax.taj.gov.jm) allows employers to file the annual return online. You will need your employer login credentials.
...
|---|---|---|
| Missing or incorrect TRN | Return flagged; employee contributions not credited | Verify TRNs before submission |
| Under-reported gross wages (basic salary only) | PAYE under-deduction detected; potential reassessment | Include all remuneration |
| Omitting employees who left during the year | Incomplete return; missing contribution records | Include all employees for any period of the year |
| NIS contributions above the annual ceiling | Over-reporting detected; refund owed to employee | Check ceiling and cap each employee's NIS total |
| Duplicate employee entries | Inflated totals; processing errors | Consolidate records for rehired or role-changed employees |
| Totals don't reconcile with monthly remittances | TAJ query triggered | Reconcile before filing, not after |
...
**[Use the PayrollJamaica free payroll calculator](https://payrolljamaica.com/calculator)** to verify your deduction calculations before you submit — it's free, takes 30 seconds, and could catch an error that would otherwise trigger a TAJ query.
