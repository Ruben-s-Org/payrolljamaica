---
title: "How to Pay PAYE Online in Jamaica: Complete eTAJ Guide for Employers (2026)"
description: "Step-by-step guide to paying PAYE online in Jamaica using the eTAJ portal. Covers registration, payment methods, what to do if payment fails, and how to confirm your remittance before the deadline."
date: "2026-03-12"
tags: ["how to pay PAYE Jamaica", "eTAJ portal Jamaica", "PAYE online payment Jamaica", "TAJ employer portal", "pay PAYE online Jamaica 2026", "Jamaica employer tax payment", "S02 remittance Jamaica"]
author: "Payroll Jamaica Team"
canonical: "https://payrolljamaica.com/blog/how-to-pay-paye-online-jamaica-etaj-2026"
---

# How to Pay PAYE Online in Jamaica: Complete eTAJ Guide for Employers (2026)
...
Access the portal at [etaj.gov.jm](https://etaj.gov.jm). You will need an employer TRN (Taxpayer Registration Number) and a password created during registration.
...
1. Go to etaj.gov.jm
2. Click "Register" or "New User"
3. Enter your TRN and follow the account creation steps
4. Confirm your email address via the verification link TAJ sends
...
1. Go to etaj.gov.jm and log in with your TRN and password
2. From the dashboard, select **"Employer"** or **"Payroll Returns"** (exact menu label may vary by portal version)
3. Select **S02 Monthly Return** for monthly remittances
...
- Total employee Education Tax (2.25% of gross)
- Total employer Education Tax (3.5% of gross)
...
**Income Tax Threshold for 2025:** J$1,500,096 per year (J$125,008 per month). Employees earning below this threshold have no PAYE liability. Earnings above it are taxed at the applicable rate.
...
1. **Immediate confirmation**: eTAJ should display a payment receipt or confirmation number after successful submission. Save or screenshot this.
2. **Email receipt**: TAJ sends email confirmations to your registered eTAJ email. Check within 24 hours.
3. **Portal confirmation**: Log back into eTAJ after 1–2 business days and verify the S02 return for that period shows as "Paid" or "Filed" rather than "Pending."
...
**"My payment went through at my bank but eTAJ still shows Pending"**
This usually means the payment reference did not match your TRN correctly. Contact TAJ with your bank's proof of payment and your TRN. TAJ can manually match the payment to your account. Do this immediately — do not wait until the next deadline cycle.

**"I filed the S02 with the wrong figures"**
Contact TAJ promptly. In most cases, you can file an amended return. The longer you wait, the more complicated the correction. If you overpaid, TAJ maintains a credit on your account which can offset future liabilities.

**"eTAJ is down near the deadline"**
...
**"I forgot to file for one or more previous months"**
...
1. Ensure all 12 monthly S02 returns for April 2025–March 2026 are filed and paid
2. File the SO1 Annual Return via eTAJ
3. File the NHT Annual Return via the NHT employer portal
4. Submit the NIS Reconciliation to the Ministry of Labour and Social Security
